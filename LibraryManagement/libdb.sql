...
IN name VARCHAR(255),
IN identityCard VARCHAR(255),
IN phoneNO VARCHAR(255),
IN job VARCHAR(255)
)	
BEGIN
 INSERT INTO reader(surname,NAME,identityCard,phoneNO,job, cardIssueDate)
 VALUE (surname,NAME,identityCard,phoneNO,job, CURRENT_DATE());
END $$
DELIMITER ;
/*CALL sp_addReader(surname,NAME,identityCard,phoneNO,job);*/
